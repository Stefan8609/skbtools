...
def geigerTimePlot(
    ...
    fig, axes = plt.subplots(
        ...
        3,
        figsize=(15, 10),
        gridspec_kw={"width_ratios": [1, 4, 2], "height_ratios": [4, 1]},
    )
    fig.suptitle(
        "Comparison of calculated arrival times and actual arrival times", y=0.92
    )
    fig.text(
        0.05,
        0.5,
    ...
    axes[0, 1].text(
        25,
        max(times_known),
        "actual arrival times versus estimated times",
