...
def RMSE_function(lever, GPS_Coordinates, guess, gps1_to_others, CDog, transponder_coordinates_Actual, times_known):
    # Find RMS
...
def simulated_annealing_optimized(n, iter, time_noise, position_noise, geom_noise=0, main=True,
    ...
    transponder_coordinates_Found = findTransponder(GPS_Coordinates, gps1_to_others, lever_old)
    ...
    while k < iter - 1:
        ...
        RMSE_arr = np.array([RMSE_function(lever, GPS_Coordinates, guess, gps1_to_others,
                                           CDog, transponder_coordinates_Actual, times_known) for lever in levers])
        ...
        while RMSE_reduction < 0:
            ...
            RMSE_new = RMSE_function(lever_new, GPS_Coordinates, guess, gps1_to_others,
                                           CDog, transponder_coordinates_Actual, times_known)
