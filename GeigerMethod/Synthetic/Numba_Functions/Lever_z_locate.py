...
esv_table_generate = sio.loadmat(f'../../../GPSData/global_table_esv.mat')
...
esv_table_inversion = sio.loadmat(f'../../../GPSData/global_table_esv_realistic_perturbed.mat')
