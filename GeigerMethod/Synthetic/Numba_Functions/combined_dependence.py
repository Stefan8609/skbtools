...
def combined_dependence():
    ...
    for i in range(len(X[0])):
        ...
        for j in range(len(Y[:,0])):
            ...
            (inversion_result, CDOG_data, CDOG_full, GPS_data, GPS_full, CDOG_clock, GPS_clock, CDOG,
    ...
    CS = plt.contour(X*100, Y*1000000, Z_stdexp*1515*100, colors="k", levels=np.arange(0,14,2))
