...
CDOG_data, CDOG, GPS_Coordinates, GPS_data, true_transponder_coordinates = generateUnalignedRealistic(20000, true_offset)
...
plt.scatter(GPS_times, travel_times, s=1, label="Model Travel Times")
plt.legend()
