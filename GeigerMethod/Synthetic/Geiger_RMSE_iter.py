...
import random
from advancedGeigerMethod import generateRealistic, calculateTimesRayTracing, findTransponder, computeJacobianRayTracing
...
def RMSE_iter_plot(n, runs, time_noise, position_noise):
    for i in range(runs):
        ...
        guess = np.array([random.uniform(-10000, 10000), random.uniform(-10000, 10000), random.uniform(-4000, -6000)])
    ...
    plt.title(f"RMSE by iteration of Geiger's Method: \n"
