...
from Inversion_Workflow.Forward_Model.Calculate_Times_Bias import calculateTimesRayTracing_Bias_Real
...
# time_series_plot(data["CDOG_clock"], data["CDOG_full"], data["GPS_clock"], data["GPS_full"], path = save_path, save=True, zoom_start=35000, DOG_num=file_tag)
