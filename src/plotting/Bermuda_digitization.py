...
if __name__ == "__main__":
    ...
    if measurement is not None:
        file = gps_data_path("Figs/Images/Atlantic_Explorer_Schematic/measurement.txt")
    ...
    #
    #
    # bridge_shifted = _shift_segments(bridge_segments, y_shift=bridge_center,
    # x_shift=bridge_x_shift)
    # ship_shifted = _shift_segments(ship_segments, y_shift=ship_center)
    #
    # # plot them
    # plot_segments(np.concatenate([bridge_shifted, ship_shifted]))
